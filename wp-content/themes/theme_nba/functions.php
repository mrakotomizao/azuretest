...
function gridsby_scripts()
{
    ...
    wp_enqueue_script('gridsby-images-loaded', get_template_directory_uri() . '/js/imagesloaded.pkgd.js', array(),
        false, false);
    wp_enqueue_script('gridsby-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206',
        true);
    wp_enqueue_script('gridsby-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js',
        array(), '20130115', true);
    ...
    wp_enqueue_script('gridsby-pushMenu', get_template_directory_uri() . '/js/jPushMenu.js', array('jquery'), false,
        true);
    wp_enqueue_script('gridsby-modernizr', get_template_directory_uri() . '/js/modernizr.custom.js', array(), false,
        false);
    ...
    if (is_page_template('page-home.php') || is_page_template('page-gallery.php') || is_page_template('page-full-gallery.php')) {
        ...
        wp_enqueue_script('gridsby-masonry', get_template_directory_uri() . '/js/masonry.pkgd.js', array(), false,
            true);
        wp_enqueue_script('gridsby-gridsby-gallery', get_template_directory_uri() . '/js/gridsby-gallery.js', array(),
            false, true);
...
function gridsby_gallery_script_includes($template)
{
    ...
    if (is_category() || is_tag()) {
        ...
        if ($gallery_view) {
            ...
            wp_enqueue_script('gridsby-masonry', get_template_directory_uri() . '/js/masonry.pkgd.js', array(), false,
                true);
            wp_enqueue_script('gridsby-gridsby-gallery', get_template_directory_uri() . '/js/gridsby-gallery.js',
                array(), false, true);
        }
    }
...
add_action('XmlHookPost', 'createPostFromXML');
